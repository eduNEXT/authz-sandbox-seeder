...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd authz_sandbox_seeder && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd authz_sandbox_seeder && i18n_tool generate

detect_changed_source_translations:
	cd authz_sandbox_seeder && i18n_tool changed
...
pull_translations:
	find authz_sandbox_seeder/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/authz-sandbox-seeder/authz_sandbox_seeder/conf/locale:authz_sandbox_seeder/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd authz_sandbox_seeder && i18n_tool dummy
